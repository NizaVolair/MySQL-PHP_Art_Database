...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Art Archive: Artwork - Not In A Series</title>
		<link rel="stylesheet" href="style.css" type="text/css">
	</head>

	<body>
		<h1>Artwork Not In A Series</h1>
		...
		<div>
			<table>
				...
				<?php
					// Prepare artwork selection statement with relevant condition
